...
function Banner(props) {
  ...
  const [dataBanner] = useState({
    ...
    subtitle2:
      "Approving Corgis is a collection of 9,999 adorable corgis living on the Ethereum blockchain",
    title3: "CORGIS SPOTLIGHT",
    subtitle3:
      "Literally no two Corgis are alike. With a wide array of fur colors, facial features, outfits, headwear, accessories",
          ...
          <div className="col-md-12">
            ...
            <div className="banner-top__sale">
              ...
              <div className="token-bar">
                <div className="top">
                  <h6>
                    Raised - <span>{dataBanner.token_bar1}</span>
                  </h6>
                  <h6>
                    Target - <span>{dataBanner.token_bar2}</span>
                  </h6>
                </div>
                <div className="main">
            ...
            <div className="banner-top__main center">
              <Image
                src={require("../../../assets/images/layout/banner-nft.png")}
                alt="ICOLand"
                style={{ height: "auto" }}
              />

              <div className="buy-token-box">
                <h2 className="heading">{dataBanner.title2}</h2>
